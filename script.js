let start1 = document.querySelector(".medium"); // Легкий рівень
let start2 = document.querySelector(".easy"); // Середній рівень
let start3 = document.querySelector(".hard"); // Важкий рівень
